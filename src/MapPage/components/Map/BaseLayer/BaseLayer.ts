...
const BaseLayer = (
  ...
  useEffect(() => {
    ...
    // Keep the mobile map lightweight. Desktop should use MapLibre's default
    // worker scheduling rather than a strict worker-count override.
    if (isMobile) setWorkerCount(1);

...
import { VIEWPORT_OVERSCAN_BOTTOM_PX, DESKTOP_LEFT_OFFSET_PX } from './viewportOffsets';
...
const readViewportParams = (
    ...
    const bottomOffset = Math.max(0, Math.min(mobileBottomOffset, canvas.clientHeight - 1)) - VIEWPORT_OVERSCAN_BOTTOM_PX;

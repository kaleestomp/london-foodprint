...
import {
    DESKTOP_HEATMAP_OPACITY,
    MOBILE_HEATMAP_LAYER, MOBILE_HEATMAP_OPACITY
} from './heatmapLayerConfig';
...
const heatmapLayer = (
    ...
    return {
        ...
        paint: {
            ...
            'heatmap-radius': MOBILE_HEATMAP_LAYER,

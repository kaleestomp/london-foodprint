...
const PanelSnapMapViewportSync: React.FC<Props> = ({ mapRef }) => {
  const { isMobile, snapState, panelHeight, translateY } = useRestaurantPanelSnapState();
...
export default PanelSnapMapViewportSync;
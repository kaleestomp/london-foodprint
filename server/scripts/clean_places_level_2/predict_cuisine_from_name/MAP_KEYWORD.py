...
KEYWORD_MAP: list[tuple[str, str]] = [
    ...
    (r"\bbistro\b", "bistro"),
    (r"\bgolden\s?palace\b|\bshanghai\b|\bxien\b|\bmalatang\b", "chinese_restaurant"),
    ...
    (r"\b(?:indian|curry|tandoor|tandoori|masala|biryani|chaat)\b", "indian_restaurant"),
    ...
    (r"\bpizzeria\b|\bpizza\b|\bpepperoni\b", "pizza_restaurant"),
    ...
    (r"\b(?:lobsters?|crab|shrimp|seafood|fish|fishnets|fisheries)\b", "seafood_restaurant"),

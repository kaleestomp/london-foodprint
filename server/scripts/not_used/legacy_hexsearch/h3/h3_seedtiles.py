...
from server.scripts.adaptive_hexsearch.h3.h3_api import _h3_polyfill, _h3_cell_to_shapely, _h3_cell_center
from server.scripts.adaptive_hexsearch.h3.config import SOURCE_CRS, H3_EDGE_LENGTH_M, H3_INITIAL_RESOLUTION, SEED_ORDER_REFERENCE
...
def get_seed_cells(union_wgs84, resolution: int, bbox_buffer_deg: float = 0.03) -> gpd.GeoDataFrame:
    ...
    seed_geodf['fetch_success'] = seed_geodf['fetch_success'].astype(bool)

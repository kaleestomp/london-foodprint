...
from server.scripts.adaptive_hexsearch.h3.config import SOURCE_CRS, H3_EDGE_LENGTH_M, H3_INITIAL_RESOLUTION, LEVEL_COLORS
...
def visualize_seed(seed_geodf, boundary, output_path="out/h3hex_seed_map.html"):
    ...
    for _, row in seed_geodf.iterrows():
        ...
        weight = 600 if row['current'] is True else 400

...
import random
from server.scripts.adaptive_hexsearch.h3.h3_api import _h3_cell_to_shapely, _h3_cell_center, _h3_get_children
from server.scripts.adaptive_hexsearch.h3.config import SOURCE_CRS, H3_EDGE_LENGTH_M, MAX_DEPTH, SATURATION_THRESHOLD
    ...
    while queue:
        ...
        if disable_api: # Mock API Call  
            ...
            try:
                ...
                ]).to_csv(out_places_dir / f"{row['tile_path_id']}[error].csv", index=False)

# Restaurant Info Panel Rebuild Brief

## Goal
Rebuild RestaurantInfoPanel as a clean, maintainable module with explicit mobile and desktop behavior.
...
- Split render concerns into dedicated components:
  - `RestaurantInfoPanel` for container + layout
